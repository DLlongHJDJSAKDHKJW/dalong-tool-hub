...
contextBridge.exposeInMainWorld('libraryBridge', {
  ...
  getNodeSnippets: (category, group) => ipcRenderer.invoke('library:get-node-snippets', category, group),
  ...
  openNodeDirectory: (category, group) => ipcRenderer.invoke('library:open-node-directory', category, group),
